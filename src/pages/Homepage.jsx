...
import { fetchCategory } from "../redux/slice/BaseSlice";
...
export default function Homepage() {
  ...
  const categoryData = useSelector((state) => state.BaseSlice.categoryData.data);
  ...
  return (
    <>
                    ...
                    <Link to='/'>
                      <div className="category-boxes">
                        <div className="img-sec">
                          <img
                            src="./images/icon/vegetables/veg.png"
                            className="img-fluid"
                            alt=""
                          />
                        </div>
              ...
              <a href="category-page.html">
                <div className="collection-banner p-right text-end">
                  <div className="img-part">
                    <img
                      src="./images/vegetables-4/banner/1.png"
            ...
            <div className="col-6 col-lg-4">
              <a href="category-page.html">
                <div className="collection-banner p-right text-end">
                  <div className="img-part">
                    <img
                      src="./images/vegetables-4/banner/2.png"
                      className="img-fluid  w-100"
                      alt=""
                    />
                  </div>
            ...
            <div className="col-6 col-lg-4">
              <a href="category-page.html">
                <div className="collection-banner p-right text-end">
                  <div className="img-part">
                    <img
                      src="./images/vegetables-4/banner/3.png"
                      className="img-fluid  w-100"
                      alt=""
                    />
                  </div>
      ...
      <section className="gift-card-section ratio2_1">
        <div className="container">
              ...
              <div className="col-md-4">
                <a href="category-page.html">
                  <div className="collection-banner p-right text-center">
                    <div className="img-part">
                      <img
                        src="./images/vegetables-4/banner/4.png"
                        className="img-fluid"
                        alt=""
                      />
                    </div>
              ...
              <div className="col-md-4">
                <a href="category-page.html">
                  <div className="collection-banner p-right text-center">
                    <div className="img-part">
                      <img
                        src="./images/vegetables-4/banner/5.png"
                        className="img-fluid"
                        alt=""
                      />
                    </div>
              ...
              <div className="col-md-4">
                <a href="category-page.html">
                  <div className="collection-banner p-right text-center">
                    <div className="img-part">
                      <img
                        src="./images/vegetables-4/banner/6.png"
                        className="img-fluid"
                        alt=""
                      />
                    </div>
      ...
      <section className="service-w-bg banner-padding theme-bg-service">
        <div className="container">
